...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtResponse login(LoginRequest r) {
        ...
        User u = userRepository.findByUsername(r.getUsername()).orElseThrow(() -> new ApiException("User not found"));
    ...
    public JwtResponse registerPatient(RegisterRequest r) {
        if (userRepository.existsByUsername(r.getUsername()) || userRepository.existsByEmail(r.getEmail()))
            throw new ConflictException("Username or email already exists");
        User u = userRepository.save(
                User.builder().username(r.getUsername()).email(r.getEmail()).fullName(r.getFullName())
